...
mixin _$WifiNetwork {
 ...
 String get ssid; int get signalStrength;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WifiNetwork&&(identical(other.ssid, ssid) || other.ssid == ssid)&&(identical(other.signalStrength, signalStrength) || other.signalStrength == signalStrength));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,ssid,signalStrength);

@override
String toString() {
  return 'WifiNetwork(ssid: $ssid, signalStrength: $signalStrength)';
}
...
/// Create a copy of WifiNetwork
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? ssid = null,Object? signalStrength = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String ssid,  int signalStrength)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WifiNetwork() when $default != null:
return $default(_that.ssid,_that.signalStrength);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String ssid,  int signalStrength)  $default,) {final _that = this;
switch (_that) {
case _WifiNetwork():
return $default(_that.ssid,_that.signalStrength);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String ssid,  int signalStrength)?  $default,) {final _that = this;
switch (_that) {
case _WifiNetwork() when $default != null:
return $default(_that.ssid,_that.signalStrength);case _:
  return null;
...
class _WifiNetwork implements WifiNetwork {
  const _WifiNetwork({required this.ssid, required this.signalStrength});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WifiNetwork&&(identical(other.ssid, ssid) || other.ssid == ssid)&&(identical(other.signalStrength, signalStrength) || other.signalStrength == signalStrength));
}
...
/// Create a copy of WifiNetwork
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? ssid = null,Object? signalStrength = null,}) {
